...
var taskFormHandler = function(event) {
  ...
  // no data attribue, so create object as normal and pass to createTaskEl function
  else {
    var taskDataObj = {
      name: taskNameInput,
      type: taskTypeInput,
...
var createTaskEl = function(taskDataObj) {
  ...
  // add entire list item to appropriate list
...
var loadTasks = function() {
  ...
  // convert tasks from JSON string to array of objects
  savedTasks = JSON.parse(savedTasks);

  // loop over the tasks array, creating each task element and adding it to the page
